...
for line in datacsv:
    ...
    if record_counter % 10000 == 0:
        ...
        jsonstring = jsonstring[:-2] # gets rid of trailing comma, linebreak
        jsonstring += ']' # debug?
...
delta_str = str(datetime.timedelta(seconds=delta.seconds))
print 'total elapsed ingestion  time: ' + delta_str
